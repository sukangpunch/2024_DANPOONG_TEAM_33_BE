package com.example.onetry.oauth.controller;

import com.example.onetry.common.CommonResponseDto;
import com.example.onetry.oauth.dto.TokenResDto;
import com.example.onetry.oauth.service.KaKaoOAuth2Service;
...
@Tag(name = "[KaKao OAuth2] KaKao OAuth2 API 카카오 OAuth2 로그인")
@RestController
