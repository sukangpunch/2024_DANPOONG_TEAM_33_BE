package com.example.onetry.transcript.controller;
...
import com.example.onetry.transcript.service.TranscriptService;
...
@Tag(name = "[Transcript] 성적 증명서를 추가, 조회 , 삭제합니다.")
@RestController
...
public class TranscriptController {
    ...
    @GetMapping("/all")
    public ResponseEntity<CommonResponseDto<List<TranscriptInfo>>> getAllTranscript(
    ...
    public ResponseEntity<CommonResponseDto<TranscriptInfo>> addTranscript(
            @ModelAttribute TranscriptCreateDto transcriptCreateDto,
            @AuthenticationPrincipal UserDetails userDetails){
        String email = userDetails.getUsername();
