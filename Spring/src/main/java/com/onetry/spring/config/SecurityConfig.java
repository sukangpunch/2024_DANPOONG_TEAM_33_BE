...
import com.onetry.spring.exception.security.CustomAccessDeniedHandler;
import com.onetry.spring.exception.security.CustomAuthenticationEntryPoint;
import com.onetry.spring.jwt.JwtAuthFilter;
...
//                        .userService(customOAuth2UserService)).successHandler(customSuccessHandler));
    ...
    public CorsConfigurationSource configurationSource(){
        ...
        configuration.addAllowedOrigin("https://onet-test.vercel.app");
